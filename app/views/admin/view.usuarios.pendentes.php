...
$pendentes = usuario::listarPendentes($_SESSION['fk_unidade']);
?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="../../controllers/controller.usuario.aprovar.php?id=<?= (int) $linha[0] ?>&acao=aprovar"
                                       ...
                                       onclick="return confirm('Aprovar este usuário?')">Aprovar</a>
                                    <a href="../../controllers/controller.usuario.aprovar.php?id=<?= (int) $linha[0] ?>&acao=rejeitar"
                                       class="btn btn-danger btn-sm"
                                       onclick="return confirm('Rejeitar este usuário?')">Rejeitar</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr><td colspan="5" class="text-center">Nenhum usuário pendente.</td></tr>
                    <?php endif; ?>
                    </tbody>
                </table>
            </div>
