            ...
            <div class="card shadow-sm mb-4 border-top border-primary border-4">
                <div class="card-body">
                    ...
                    <div class="mb-3 p-3 bg-light rounded border">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h4 class="text-primary mb-0 text-uppercase fw-bold"><?= htmlspecialchars($fichaAtual[3]) ?></h4>
                            
                            <!-- Botão de impressão enviando o id_aluno E o id_ficha individual -->
                            <a href="view.ficha.imprimir.php?id_aluno=<?= $id_aluno ?>&id_ficha=<?= $fichaAtual[0] ?>" target="_blank" class="btn btn-dark btn-sm">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="../../controllers/controller.ficha.treino.delete.php?id_ficha=<?= $fichaAtual[0] ?>&id_aluno=<?= $id_aluno ?>" class="btn btn-danger">
                                            Sim, excluir
                                        </a>
                                    </div>
                                </div>
